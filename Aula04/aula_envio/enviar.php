...
$mail->addAddress($email, 'Fulano de Tal'); // email do destinatario
...
$mail->Body = '<strong>'. $content . '</strong>'; // conteúdo da mensagem em html
...
echo "<table align = center>
            <tr> 
                <td 
                    style=\"font-family: 'Times New Roman', Times serif; font-size: large; width: 300px; height:10px; background: rgb(176, 194, 71); text-align: center \"> 
                        Mensagem de Operação 
                </td>
            </tr>
            <tr>
                <td 
                    style=\"font-family: 'Times New Roman', Times, serif; font-size: large; width: 300px; height:100px; background: rgb(104, 71, 194); text-align: center;\"> 
                        Envio bem Sucedido,<br>Parabéns! 
                </td>
            </tr>
     </table>";
}
